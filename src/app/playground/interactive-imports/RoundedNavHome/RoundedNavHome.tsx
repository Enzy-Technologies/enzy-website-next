import svgPaths from "./svg-hge5cgpiss";

export default function RoundedNavHome({ className }: { className?: string }) {
  return (
    <div className={className || "content-stretch flex gap-[16px] items-center relative"} data-name="RoundedNav/Home">
