  ...
  return (
    <section className="relative w-full px-4 py-16 md:py-20 lg:py-24 max-w-7xl mx-auto">
      <motion.div
        ...
        className={`w-full max-w-[900px] mx-auto liquid-glass relative overflow-hidden rounded-[28px] rounded-tl-[12px] rounded-br-[44px] md:rounded-[34px] md:rounded-tl-[16px] md:rounded-br-[52px] p-8 md:p-12 text-left ring-1 ${
      ...
      >
        ...
        <div className="mb-6 flex items-center gap-1.5" aria-hidden>
          ...
          <span
            className={`ml-2 font-inter text-[11px] font-semibold uppercase tracking-[0.14em] ${
              isLightMode ? "text-black/40" : "text-white/45"
            }`}
          >
            Verified customer
          </span>
        ...
        <blockquote className="m-0 relative z-10">
          <p
            className={`font-ivyora italic text-[22px] md:text-[28px] lg:text-[32px] leading-[1.35] tracking-[-0.4px] ${
        ...
        <footer
          className={`flex flex-row items-center gap-4 mt-8 md:mt-10 pt-6 md:pt-8 border-t relative z-10 ${
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            <p
              className={`font-inter text-[15px] md:text-[17px] font-semibold tracking-tight m-0 ${
                isLightMode ? "text-brand-dark" : "text-brand-light"
              }`}
            >
              {testimonial.name}
            ...
            <p
              className={`font-inter text-[13px] md:text-[14px] mt-1 m-0 ${
