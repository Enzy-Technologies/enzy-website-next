...
export function SiteShell({
  ...
  // pricing tool (a self-contained iframe document) opts out. Mobile opts out
  // inside PixelCanvas itself — it's hidden via CSS (so it never paints, not even
  // for one frame) and its animation loop is skipped on phones — which is why
  // there's no mobile check here.
  const showParticles = pathname !== "/pricing-tool"
