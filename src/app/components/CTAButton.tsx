 ...
 *   Frosted (semi-transparent + heavy blur), never fully opaque: white fill in light mode, grey fill in dark. Holds steady on hover.
 */
...
const secondaryClasses =
  "relative flex items-center justify-center px-6 py-3 rounded-full border font-inter font-medium text-[13px] transition-all active:scale-95 whitespace-nowrap w-full pointer-events-auto border-black/15 bg-white/80 text-[#0b0f14] shadow-[0_1px_3px_rgba(0,0,0,0.08)] backdrop-blur-2xl dark:border-white/15 dark:bg-neutral-600/80 dark:text-white dark:shadow-none";
