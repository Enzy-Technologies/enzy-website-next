...
function PartnerLogo({
  ...
  return (
    <span
      className="flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl transition-transform duration-300 group-hover:scale-105 bg-white shadow-[0_4px_14px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_14px_rgba(0,0,0,0.35)] ring-1 ring-black/5 dark:ring-white/10"
    >
      {logoFailed ? (
    ...
    <FadeInSection delay={Math.min(index, 6) * 0.06} className="flex">
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <h3
            className="font-inter text-[20px] font-semibold tracking-tight text-black dark:text-white"
          >
            {partner.name}
          </h3>
          <p
            className="font-inter text-[14px] leading-relaxed text-black/65 dark:text-white/65"
          >
            {partner.blurb}
          </p>
        </div>
