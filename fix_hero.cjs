...
// The goal is to remove the PlaygroundSurface component and its associated state/hooks
// from HeroSectionDefault, and center the hero text.

// 1. Remove PlaygroundSurface component definition
...
// 2. Remove QUESTIONS array and types
...
// 5. Remove PlaygroundSurface call
...
// 6. Change the left column to be centered and full width
