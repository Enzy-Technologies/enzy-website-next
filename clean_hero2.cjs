...
// I need to clean up HeroSectionDefault which still has old state left over from the git checkout
...
if (content.includes(oldHeroStart)) {
  ...
  console.log("Cleaned up HeroSectionDefault state and hooks");
}
