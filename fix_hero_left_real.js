...
// Find the start and end of HeroSectionDefault
const startIdx = content.indexOf('function HeroSectionDefault() {');
const endIdx = content.indexOf('export function HeroSection(');
...
`;
  ...
  content = content.substring(0, startIdx) + newHeroDefault + content.substring(endIdx);
  fs.writeFileSync(path, content);
  console.log("Successfully replaced HeroSectionDefault");
} else {
